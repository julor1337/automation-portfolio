...
Turns client intake rows into onboarding packets, risk flags, kickoff tasks, and approval gates.
...
## Automation Mapping
Intake sheet -> task template node -> risk review -> folder plan -> kickoff packet draft.
