...
Validates local JSON webhook payloads, routes supported events, and writes replay-safe debug logs.
...
## Automation Mapping
Webhook payload -> schema validator -> event router -> JSONL log -> owner-reviewed fix list.
