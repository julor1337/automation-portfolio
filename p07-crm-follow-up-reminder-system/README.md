...
Finds due CRM follow-ups, sorts opportunities by value, and prepares no-send reminder drafts.
...
## Automation Mapping
CRM export -> due-date detector -> value sorter -> reminder draft -> owner approval before sending.
