...
Parses synthetic invoice text, validates fields, categorizes expenses, and builds audit-friendly summaries.
...
## Automation Mapping
Invoice text/OCR output -> parser -> validation -> category report -> owner-approved bookkeeping review.
