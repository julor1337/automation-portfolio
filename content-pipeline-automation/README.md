...
Scores content ideas, schedules drafts, and creates human-approved publishing checklists without posting.
...
## Automation Mapping
Idea sheet -> scoring node -> calendar builder -> draft outline -> owner-approved publishing queue.
